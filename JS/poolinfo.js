document.addEventListener("DOMContentLoaded", function () {
    ...
    async function fetchPoolInfo() {
        try {
            const response = await axios.get("https://final-git-main-shahs-projects-6e930787.vercel.app/api/poolinfos");
    ...
    async function ChartData() {
        const response = await fetch("https://final-git-main-shahs-projects-6e930787.vercel.app/api/poolinfos");
